    ...
    <el-container v-loading="loading"style="width: 1152px;margin:0 auto">
      <el-header height=283px>
            ...
            <div v-if="!isMyPortal" class="person_image">
                ...
                <div v-if="!(userId.length>0)">
                  <el-button style="text-align:center;margin-top: 10px;margin-bottom: 10px;" type="info" disabled>您未登录</el-button>
                </div>
            	</div>
            </div>"
                ...
                <el-link v-if="insName!='暂无'" :underline="false" @click.native="gotoInstitution(insName)">
